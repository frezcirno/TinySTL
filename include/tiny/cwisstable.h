...
#if defined(__SSE2__) || (CWISS_IS_MSVCISH && (defined(_M_X64) || (defined(_M_IX86) && _M_IX86_FP >= 2)))
...
#endif
#if defined(__SANITIZE_MEMORY__) || (CWISS_HAVE_FEATURE(memory_sanitizer) && !defined(__native_client__))
...
/// a type-generic fashion.
#define CWISS_LeadingZeros(x_) (CWISS_LeadingZeroes64(x_) - (uint32_t)((sizeof(unsigned long long) - sizeof(x_)) * 8))
...
static inline CWISS_ControlByte *CWISS_EmptyGroup() {
  ...
  alignas(16) static const CWISS_ControlByte kEmptyGroup[16] = {
      CWISS_kSentinel, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty,
      CWISS_kEmpty,    CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty, CWISS_kEmpty,
  };
...
/// salt.
static inline size_t CWISS_H1(size_t hash, const CWISS_ControlByte *ctrl) { return (hash >> 7) ^ CWISS_HashSeed(ctrl); }
...
static inline bool CWISS_IsEmpty(CWISS_ControlByte c) { return c == CWISS_kEmpty; }

/// Returns whether `c` is full.
static inline bool CWISS_IsFull(CWISS_ControlByte c) { return c >= 0; }

/// Returns whether `c` is deleted.
static inline bool CWISS_IsDeleted(CWISS_ControlByte c) { return c == CWISS_kDeleted; }

/// Returns whether `c` is empty or deleted.
static inline bool CWISS_IsEmptyOrDeleted(CWISS_ControlByte c) { return c < CWISS_kSentinel; }
...
#define CWISS_Group_BitMask(x) (CWISS_BitMask){(uint64_t)(x), CWISS_Group_kWidth, CWISS_Group_kShift};
...
static inline size_t CWISS_NumClonedBytes(void) { return CWISS_Group_kWidth - 1; }

/// Returns whether `n` is a valid capacity (i.e., number of slots).
///
/// A valid capacity is a non-zero integer `2^m - 1`.
static inline bool CWISS_IsValidCapacity(size_t n) { return ((n + 1) & n) == 0 && n > 0; }
...
CWISS_INLINE_NEVER static bool CWISS_ShouldInsertBackwards(size_t hash, const CWISS_ControlByte *ctrl) {
...
static inline void CWISS_SetCtrl(size_t i, CWISS_ControlByte h, size_t capacity, CWISS_ControlByte *ctrl,
...
static inline size_t CWISS_NormalizeCapacity(size_t n) { return n ? SIZE_MAX >> CWISS_LeadingZeros(n) : 1; }
...
static inline bool CWISS_IsSmall(size_t capacity) { return capacity < CWISS_Group_kWidth - 1; }
...
static inline CWISS_ProbeSeq CWISS_ProbeSeq_Start(const CWISS_ControlByte *ctrl, size_t hash, size_t capacity) {
...
static inline CWISS_FindInfo CWISS_FindFirstNonFull(const CWISS_ControlByte *ctrl, size_t hash, size_t capacity) {
  ...
  while (true) {
    ...
    if (mask.mask) {
      ...
      if (!CWISS_IsSmall(capacity) && CWISS_ShouldInsertBackwards(hash, ctrl)) {
        return (CWISS_FindInfo){CWISS_ProbeSeq_offset(&seq, CWISS_BitMask_HighestBitSet(&mask)), seq.index_};
      }
#endif
      return (CWISS_FindInfo){CWISS_ProbeSeq_offset(&seq, CWISS_BitMask_TrailingZeros(&mask)), seq.index_};
    }
...
CWISS_INLINE_NEVER
static uint64_t CWISS_AbslHash_LowLevelHash(const void *data, size_t len, uint64_t seed, const uint64_t salt[5]) {
  ...
  if (len > 64) {
    ...
    do {
      ...
      uint64_t ds0 = CWISS_AbslHash_LowLevelMix(chunk[4] ^ salt[3], chunk[5] ^ duplicated_state);
      uint64_t ds1 = CWISS_AbslHash_LowLevelMix(chunk[6] ^ salt[4], chunk[7] ^ duplicated_state);
...
static inline size_t CWISS_FxHash_Finish(CWISS_FxHash_State state) { return state; }
...
static inline size_t CWISS_AbslHash_Finish(CWISS_AbslHash_State state) { return state; }
...
#define CWISS_EXTRACT00(needle_, kv_, ...) \
  CWISS_SELECT00(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT01, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT01(needle_, kv_, ...) \
  CWISS_SELECT01(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT02, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT02(needle_, kv_, ...) \
  CWISS_SELECT02(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT03, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT03(needle_, kv_, ...) \
  CWISS_SELECT03(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT04, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT04(needle_, kv_, ...) \
  CWISS_SELECT04(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT05, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT05(needle_, kv_, ...) \
  CWISS_SELECT05(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT06, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT06(needle_, kv_, ...) \
  CWISS_SELECT06(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT07, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT07(needle_, kv_, ...) \
  CWISS_SELECT07(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT08, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT08(needle_, kv_, ...) \
  CWISS_SELECT08(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT09, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT09(needle_, kv_, ...) \
  CWISS_SELECT09(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0A, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0A(needle_, kv_, ...) \
  CWISS_SELECT0A(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0B, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0B(needle_, kv_, ...) \
  CWISS_SELECT0B(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0C, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0C(needle_, kv_, ...) \
  CWISS_SELECT0C(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0D, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0D(needle_, kv_, ...) \
  CWISS_SELECT0D(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0E, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0E(needle_, kv_, ...) \
  CWISS_SELECT0E(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT0F, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT0F(needle_, kv_, ...) \
  CWISS_SELECT0F(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT10, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT10(needle_, kv_, ...) \
  CWISS_SELECT10(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT11, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT11(needle_, kv_, ...) \
  CWISS_SELECT11(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT12, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT12(needle_, kv_, ...) \
  CWISS_SELECT12(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT13, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT13(needle_, kv_, ...) \
  CWISS_SELECT13(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT14, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT14(needle_, kv_, ...) \
  CWISS_SELECT14(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT15, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT15(needle_, kv_, ...) \
  CWISS_SELECT15(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT16, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT16(needle_, kv_, ...) \
  CWISS_SELECT16(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT17, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT17(needle_, kv_, ...) \
  CWISS_SELECT17(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT18, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT18(needle_, kv_, ...) \
  CWISS_SELECT18(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT19, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT19(needle_, kv_, ...) \
  CWISS_SELECT19(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1A, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1A(needle_, kv_, ...) \
  CWISS_SELECT1A(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1B, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1B(needle_, kv_, ...) \
  CWISS_SELECT1B(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1C, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1C(needle_, kv_, ...) \
  CWISS_SELECT1C(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1D, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1D(needle_, kv_, ...) \
  CWISS_SELECT1D(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1E, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1E(needle_, kv_, ...) \
  CWISS_SELECT1E(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT1F, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT1F(needle_, kv_, ...) \
  CWISS_SELECT1F(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT20, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT20(needle_, kv_, ...) \
  CWISS_SELECT20(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT21, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT21(needle_, kv_, ...) \
  CWISS_SELECT21(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT22, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT22(needle_, kv_, ...) \
  CWISS_SELECT22(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT23, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT23(needle_, kv_, ...) \
  CWISS_SELECT23(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT24, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT24(needle_, kv_, ...) \
  CWISS_SELECT24(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT25, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT25(needle_, kv_, ...) \
  CWISS_SELECT25(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT26, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT26(needle_, kv_, ...) \
  CWISS_SELECT26(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT27, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT27(needle_, kv_, ...) \
  CWISS_SELECT27(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT28, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT28(needle_, kv_, ...) \
  CWISS_SELECT28(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT29, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT29(needle_, kv_, ...) \
  CWISS_SELECT29(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2A, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2A(needle_, kv_, ...) \
  CWISS_SELECT2A(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2B, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2B(needle_, kv_, ...) \
  CWISS_SELECT2B(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2C, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2C(needle_, kv_, ...) \
  CWISS_SELECT2C(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2D, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2D(needle_, kv_, ...) \
  CWISS_SELECT2D(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2E, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2E(needle_, kv_, ...) \
  CWISS_SELECT2E(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT2F, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT2F(needle_, kv_, ...) \
  CWISS_SELECT2F(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT30, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT30(needle_, kv_, ...) \
  CWISS_SELECT30(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT31, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT31(needle_, kv_, ...) \
  CWISS_SELECT31(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT32, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT32(needle_, kv_, ...) \
  CWISS_SELECT32(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT33, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT33(needle_, kv_, ...) \
  CWISS_SELECT33(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT34, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT34(needle_, kv_, ...) \
  CWISS_SELECT34(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT35, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT35(needle_, kv_, ...) \
  CWISS_SELECT35(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT36, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT36(needle_, kv_, ...) \
  CWISS_SELECT36(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT37, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT37(needle_, kv_, ...) \
  CWISS_SELECT37(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT38, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT38(needle_, kv_, ...) \
  CWISS_SELECT38(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT39, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT39(needle_, kv_, ...) \
  CWISS_SELECT39(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3A, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3A(needle_, kv_, ...) \
  CWISS_SELECT3A(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3B, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3B(needle_, kv_, ...) \
  CWISS_SELECT3B(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3C, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3C(needle_, kv_, ...) \
  CWISS_SELECT3C(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3D, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3D(needle_, kv_, ...) \
  CWISS_SELECT3D(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3E, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3E(needle_, kv_, ...) \
  CWISS_SELECT3E(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT3F, (needle_, __VA_ARGS__), CWISS_NOTHING)
#define CWISS_EXTRACT3F(needle_, kv_, ...) \
  CWISS_SELECT3F(needle_ kv_, CWISS_EXTRACT_VALUE, kv_, CWISS_EXTRACT40, (needle_, __VA_ARGS__), CWISS_NOTHING)
...
///
/// See the header documentation for more information.
#define CWISS_DECLARE_FLAT_SET_POLICY(kPolicy_, Type_, ...) CWISS_DECLARE_POLICY_(kPolicy_, Type_, Type_, __VA_ARGS__)
...
#define CWISS_DECLARE_NODE_MAP_POLICY(kPolicy_, K_, V_, ...)                 \
  ...
  CWISS_DECLARE_POLICY_(kPolicy_, kPolicy_##_Entry, K_, __VA_ARGS__, CWISS_NODE_OVERRIDES_(kPolicy_))
...
#define CWISS_DECLARE_POLICY_(kPolicy_, Type_, Key_, ...)                                                    \
  ...
  inline void kPolicy_##_DefaultCopy(void *dst, const void *src) { memcpy(dst, src, sizeof(Type_)); }        \
  CWISS_EXTRACT_RAW(modifiers, static, __VA_ARGS__)                                                          \
  ...
  CWISS_EXTRACT_RAW(modifiers, static, __VA_ARGS__)                                                          \
  inline bool kPolicy_##_DefaultEq(const void *a, const void *b) { return memcmp(a, b, sizeof(Key_)) == 0; } \
  CWISS_EXTRACT_RAW(modifiers, static, __VA_ARGS__)                                                          \
  inline void kPolicy_##_DefaultSlotInit(void *slot) {}                                                      \
  CWISS_EXTRACT_RAW(modifiers, static, __VA_ARGS__)                                                          \
  inline void kPolicy_##_DefaultSlotTransfer(void *dst, void *src) { memcpy(dst, src, sizeof(Type_)); }      \
  CWISS_EXTRACT_RAW(modifiers, static, __VA_ARGS__)                                                          \
...
#define CWISS_DECLARE_NODE_FUNCTIONS_(kPolicy_, Type_, ...)                                                   \
  ...
  static inline void kPolicy_##_NodeSlotInit(void *slot) {                                                    \
    void *node = CWISS_EXTRACT(alloc_alloc, CWISS_DefaultMalloc, __VA_ARGS__)(sizeof(Type_), alignof(Type_)); \
  ...
  static inline void kPolicy_##_NodeSlotTransfer(void *dst, void *src) { memcpy(dst, src, sizeof(void *)); }  \
  static inline void *kPolicy_##_NodeSlotGet(void *slot) { return *((void **)slot); }                         \
  CWISS_END

#define CWISS_NODE_OVERRIDES_(kPolicy_)                                                             \
  (slot_size, sizeof(void *)), (slot_align, alignof(void *)), (slot_init, kPolicy_##_NodeSlotInit), \
      (slot_dtor, kPolicy_##_NodeSlotDtor), (slot_transfer, kPolicy_##_NodeSlotTransfer),           \
...
static inline void CWISS_DefaultFree(void *array, size_t size, size_t align) { free(array); }
...
static inline void CWISS_RawIter_SkipEmptyOrDeleted(const CWISS_Policy *policy, CWISS_RawIter *self) {
...
static inline CWISS_RawIter CWISS_RawTable_iter_at(const CWISS_Policy *policy, CWISS_RawTable *self, size_t index) {
  CWISS_RawIter iter = {
      self,
      self->ctrl_ + index,
...
/// pointer instead.
static inline CWISS_RawIter CWISS_RawTable_citer_at(const CWISS_Policy *policy, const CWISS_RawTable *self,
                                                    size_t index) {
...
static inline CWISS_RawIter CWISS_RawTable_citer(const CWISS_Policy *policy, const CWISS_RawTable *self) {
...
static inline void CWISS_RawTable_EraseMetaOnly(const CWISS_Policy *policy, CWISS_RawIter it) {
  ...
  CWISS_SetCtrl(index, was_never_full ? CWISS_kEmpty : CWISS_kDeleted, it.set_->capacity_, it.set_->ctrl_,
                it.set_->slots_, policy->slot->size);
...
/// `self_`.
static inline void CWISS_RawTable_ResetGrowthLeft(const CWISS_Policy *policy, CWISS_RawTable *self) {
...
static inline void CWISS_RawTable_InitializeSlots(const CWISS_Policy *policy, CWISS_RawTable *self) {
  ...
  char *mem = (char *)  // Cast for C++.
              policy->alloc->alloc(CWISS_AllocSize(self->capacity_, policy->slot->size, policy->slot->align),
                                   policy->slot->align);
...
static inline void CWISS_RawTable_DestroySlots(const CWISS_Policy *policy, CWISS_RawTable *self) {
  ...
  policy->alloc->free(self->ctrl_, CWISS_AllocSize(self->capacity_, policy->slot->size, policy->slot->align),
                      policy->slot->align);
...
static inline void CWISS_RawTable_Resize(const CWISS_Policy *policy, CWISS_RawTable *self, size_t new_capacity) {
  ...
  for (size_t i = 0; i != old_capacity; ++i) {
    if (CWISS_IsFull(old_ctrl[i])) {
      ...
      CWISS_SetCtrl(new_i, CWISS_H2(hash), self->capacity_, self->ctrl_, self->slots_, policy->slot->size);
      policy->slot->transfer(self->slots_ + new_i * policy->slot->size, old_slots + i * policy->slot->size);
    }
  }
  if (old_capacity) {
    CWISS_UnpoisonMemory(old_slots, policy->slot->size * old_capacity);
    policy->alloc->free(old_ctrl, CWISS_AllocSize(old_capacity, policy->slot->size, policy->slot->align),
                        policy->slot->align);
  }
...
CWISS_INLINE_NEVER
static void CWISS_RawTable_DropDeletesWithoutResize(const CWISS_Policy *policy, CWISS_RawTable *self) {
  CWISS_DCHECK(CWISS_IsValidCapacity(self->capacity_), "invalid capacity: %zu", self->capacity_);
  CWISS_DCHECK(!CWISS_IsSmall(self->capacity_), "unexpected small capacity: %zu", self->capacity_);
  // Algorithm:
  ...
  for (size_t i = 0; i != self->capacity_; ++i) {
    ...
    // best probe we can.
    const size_t probe_offset = CWISS_ProbeSeq_Start(self->ctrl_, hash, self->capacity_).offset_;
#define CWISS_ProbeIndex(pos_) (((pos_ - probe_offset) & self->capacity_) / CWISS_Group_kWidth)
    ...
    if (CWISS_LIKELY(CWISS_ProbeIndex(new_i) == CWISS_ProbeIndex(i))) {
      CWISS_SetCtrl(i, CWISS_H2(hash), self->capacity_, self->ctrl_, self->slots_, policy->slot->size);
      continue;
    }
    if (CWISS_IsEmpty(self->ctrl_[new_i])) {
      ...
      CWISS_SetCtrl(i, CWISS_kEmpty, self->capacity_, self->ctrl_, self->slots_, policy->slot->size);
    } else {
      CWISS_DCHECK(CWISS_IsDeleted(self->ctrl_[new_i]), "bad ctrl value at %zu: %02x", new_i, self->ctrl_[new_i]);
      CWISS_SetCtrl(new_i, CWISS_H2(hash), self->capacity_, self->ctrl_, self->slots_, policy->slot->size);
...
static inline void CWISS_RawTable_rehash_and_grow_if_necessary(const CWISS_Policy *policy, CWISS_RawTable *self) {
  if (self->capacity_ == 0) {
...
/// key.
static inline void CWISS_RawTable_PrefetchHeapBlock(const CWISS_Policy *policy, const CWISS_RawTable *self) {
...
static inline void CWISS_RawTable_Prefetch(const CWISS_Policy *policy, const CWISS_RawTable *self, const void *key) {
  (void)key;
...
CWISS_INLINE_NEVER
static size_t CWISS_RawTable_PrepareInsert(const CWISS_Policy *policy, CWISS_RawTable *self, size_t hash) {
  CWISS_FindInfo target = CWISS_FindFirstNonFull(self->ctrl_, hash, self->capacity_);
  ...
  CWISS_SetCtrl(target.offset, CWISS_H2(hash), self->capacity_, self->ctrl_, self->slots_, policy->slot->size);
...
/// insert it, instead.
static inline CWISS_PrepareInsert CWISS_RawTable_FindOrPrepareInsert(const CWISS_Policy *policy,
  ...
  while (true) {
    ...
    while (CWISS_BitMask_next(&match, &i)) {
      ...
      if (CWISS_LIKELY(key_policy->eq(key, policy->slot->get(slot)))) return (CWISS_PrepareInsert){idx, false};
    }
...
static inline void *CWISS_RawTable_PreInsert(const CWISS_Policy *policy, CWISS_RawTable *self, size_t i) {
...
static inline void CWISS_RawTable_reserve(const CWISS_Policy *policy, CWISS_RawTable *self, size_t n) {
...
static inline CWISS_RawTable CWISS_RawTable_dup(const CWISS_Policy *policy, const CWISS_RawTable *self) {
  ...
  for (CWISS_RawIter iter = CWISS_RawTable_citer(policy, self); CWISS_RawIter_get(policy, &iter);
    ...
    CWISS_SetCtrl(target.offset, CWISS_H2(hash), copy.capacity_, copy.ctrl_, copy.slots_, policy->slot->size);
...
static inline bool CWISS_RawTable_empty(const CWISS_Policy *policy, const CWISS_RawTable *self) { return !self->size_; }

/// Returns the number of elements in the table.
static inline size_t CWISS_RawTable_size(const CWISS_Policy *policy, const CWISS_RawTable *self) { return self->size_; }

/// Returns the total capacity of the table, which is different from the number
/// of elements that would cause it to get resized.
static inline size_t CWISS_RawTable_capacity(const CWISS_Policy *policy, const CWISS_RawTable *self) {
...
static inline CWISS_Insert CWISS_RawTable_deferred_insert(const CWISS_Policy *policy, const CWISS_KeyPolicy *key_policy,
                                                          CWISS_RawTable *self, const void *key) {
...
static inline CWISS_Insert CWISS_RawTable_insert(const CWISS_Policy *policy, CWISS_RawTable *self, const void *val) {
...
static inline CWISS_RawIter CWISS_RawTable_find_hinted(const CWISS_Policy *policy, const CWISS_KeyPolicy *key_policy,
  ...
  while (true) {
    ...
    if (CWISS_LIKELY(CWISS_Group_MatchEmpty(&g).mask)) return (CWISS_RawIter){0};
    CWISS_ProbeSeq_next(&seq);
    CWISS_DCHECK(seq.index_ <= self->capacity_, "full table!");
  }
}
...
/// `key_policy` is a possibly heterogenous key policy for comparing `key`'s
/// type to types in the map. `key_policy` may be `&policy->key`.
static inline CWISS_RawIter CWISS_RawTable_find(const CWISS_Policy *policy, const CWISS_KeyPolicy *key_policy,
...
/// `key_policy` is a possibly heterogenous key policy for comparing `key`'s
/// type to types in the map. `key_policy` may be `&policy->key`.
static inline bool CWISS_RawTable_erase(const CWISS_Policy *policy, const CWISS_KeyPolicy *key_policy,
                                        CWISS_RawTable *self, const void *key) {
...
static inline void CWISS_RawTable_rehash(const CWISS_Policy *policy, CWISS_RawTable *self, size_t n) {
...
/// `key_policy` is a possibly heterogenous key policy for comparing `key`'s
/// type to types in the map. `key_policy` may be `&policy->key`.
static inline bool CWISS_RawTable_contains(const CWISS_Policy *policy, const CWISS_KeyPolicy *key_policy,
                                           const CWISS_RawTable *self, const void *key) {
...
#define CWISS_DECLARE_LOOKUP_NAMED(HashSet_, LookupName_, Key_)                                                        \
  ...
  static inline const CWISS_KeyPolicy *HashSet_##_##LookupName_##_policy(void) {                                       \
    return &HashSet_##_##LookupName_##_kPolicy;                                                                        \
                                                                                                                       ...
                                                                                                                       \
  static inline HashSet_##_Insert HashSet_##_deferred_insert_by_##LookupName_(HashSet_ *self, const Key_ *key) {       \
    CWISS_Insert ret =                                                                                                 \
        CWISS_RawTable_deferred_insert(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key);    \
    return (HashSet_##_Insert){{ret.iter}, ret.inserted};                                                              \
  }                                                                                                                    \
  static inline HashSet_##_CIter HashSet_##_cfind_hinted_by_##LookupName_(const HashSet_ *self, const Key_ *key,       \
                                                                          size_t hash) {                               \
    return (HashSet_##_CIter){                                                                                         \
        CWISS_RawTable_find_hinted(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key, hash)}; \
  }                                                                                                                    \
  static inline HashSet_##_Iter HashSet_##_find_hinted_by_##LookupName_(HashSet_ *self, const Key_ *key,               \
                                                                        size_t hash) {                                 \
    return (HashSet_##_Iter){                                                                                          \
        CWISS_RawTable_find_hinted(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key, hash)}; \
  }                                                                                                                    \
                                                                                                                       \
  static inline HashSet_##_CIter HashSet_##_cfind_by_##LookupName_(const HashSet_ *self, const Key_ *key) {            \
    return (HashSet_##_CIter){                                                                                         \
        CWISS_RawTable_find(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key)};              \
  }                                                                                                                    \
  static inline HashSet_##_Iter HashSet_##_find_by_##LookupName_(HashSet_ *self, const Key_ *key) {                    \
    return (HashSet_##_Iter){                                                                                          \
        CWISS_RawTable_find(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key)};              \
  }                                                                                                                    \
                                                                                                                       \
  static inline bool HashSet_##_contains_by_##LookupName_(const HashSet_ *self, const Key_ *key) {                     \
    return CWISS_RawTable_contains(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key);        \
  }                                                                                                                    \
                                                                                                                       \
  static inline bool HashSet_##_erase_by_##LookupName_(HashSet_ *self, const Key_ *key) {                              \
    return CWISS_RawTable_erase(HashSet_##_policy(), &HashSet_##_##LookupName_##_kPolicy, &self->set_, key);           \
  }                                                                                                                    \
                                                                                                                       \
  CWISS_END                                                                                                            \
  /* Force a semicolon. */                                                                                             \
...
#define CWISS_DECLARE_COMMON_(HashSet_, Type_, Key_, kPolicy_)                                                         \
  CWISS_BEGIN                                                                                                          \
  static inline const CWISS_Policy *HashSet_##_policy(void) { return &kPolicy_; }                                      \
                                                                                                                       \
  typedef struct {                                                                                                     \
    CWISS_RawTable set_;                                                                                               \
  } HashSet_;                                                                                                          \
  static inline void HashSet_##_dump(const HashSet_ *self) { CWISS_RawTable_dump(&kPolicy_, &self->set_); }            \
                                                                                                                       \
  ...
  static inline void HashSet_##_destroy(HashSet_ *self) { CWISS_RawTable_destroy(&kPolicy_, &self->set_); }            \
                                                                                                                       \
  typedef struct {                                                                                                     \
    CWISS_RawIter it_;                                                                                                 \
  } HashSet_##_Iter;                                                                                                   \
  ...
  static inline HashSet_##_CIter HashSet_##_Iter_const(HashSet_##_Iter it) { return (HashSet_##_CIter){it.it_}; }      \
                                                                                                                       \
  static inline void HashSet_##_reserve(HashSet_ *self, size_t n) {                                                    \
    CWISS_RawTable_reserve(&kPolicy_, &self->set_, n);                                                                 \
  }                                                                                                                    \
  static inline void HashSet_##_rehash(HashSet_ *self, size_t n) { CWISS_RawTable_rehash(&kPolicy_, &self->set_, n); } \
                                                                                                                       \
  static inline bool HashSet_##_empty(const HashSet_ *self) { return CWISS_RawTable_empty(&kPolicy_, &self->set_); }   \
  static inline size_t HashSet_##_size(const HashSet_ *self) { return CWISS_RawTable_size(&kPolicy_, &self->set_); }   \
  static inline size_t HashSet_##_capacity(const HashSet_ *self) {                                                     \
    return CWISS_RawTable_capacity(&kPolicy_, &self->set_);                                                            \
  }                                                                                                                    \
                                                                                                                       \
  static inline void HashSet_##_clear(HashSet_ *self) { return CWISS_RawTable_clear(&kPolicy_, &self->set_); }         \
                                                                                                                       \
  typedef struct {                                                                                                     \
    HashSet_##_Iter iter;                                                                                              \
    bool inserted;                                                                                                     \
  ...
  static inline HashSet_##_Insert HashSet_##_deferred_insert(HashSet_ *self, const Key_ *key) {                        \
    CWISS_Insert ret = CWISS_RawTable_deferred_insert(&kPolicy_, kPolicy_.key, &self->set_, key);                      \
    return (HashSet_##_Insert){{ret.iter}, ret.inserted};                                                              \
  }                                                                                                                    \
  static inline HashSet_##_Insert HashSet_##_insert(HashSet_ *self, const Type_ *val) {                                \
    ...
    return (HashSet_##_Insert){{ret.iter}, ret.inserted};                                                              \
                                                                                                                       ...
                                                                                                                       \
  static inline HashSet_##_CIter HashSet_##_cfind_hinted(const HashSet_ *self, const Key_ *key, size_t hash) {         \
    return (HashSet_##_CIter){CWISS_RawTable_find_hinted(&kPolicy_, kPolicy_.key, &self->set_, key, hash)};            \
  }                                                                                                                    \
  static inline HashSet_##_Iter HashSet_##_find_hinted(HashSet_ *self, const Key_ *key, size_t hash) {                 \
    return (HashSet_##_Iter){CWISS_RawTable_find_hinted(&kPolicy_, kPolicy_.key, &self->set_, key, hash)};             \
  }                                                                                                                    \
  ...
  static inline bool HashSet_##_contains(const HashSet_ *self, const Key_ *key) {                                      \
    return CWISS_RawTable_contains(&kPolicy_, kPolicy_.key, &self->set_, key);                                         \
                                                                                                                       ...
                                                                                                                       \
  static inline void HashSet_##_erase_at(HashSet_##_Iter it) { CWISS_RawTable_erase_at(&kPolicy_, it.it_); }           \
